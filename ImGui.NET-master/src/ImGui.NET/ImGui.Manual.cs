...
namespace ImGui
{
    public static unsafe partial class Imgui
    {
            ...
            IntPtr user_data)
        {
            ...
            {
                ret = ImGuiNative.InputText(utf8LabelBytes, bufPtr, buf_size, flags, callback, user_data.ToPointer()) != 0;
            }
            ...
            IntPtr user_data)
        {
            ...
            byte* utf8InputBytes;
            byte* orInalUtf8InputBytes;
            if (inputBufSize > Util.StackAllocationSizeLimit)
            {
                utf8InputBytes = Util.Allocate(inputBufSize);
                orInalUtf8InputBytes = Util.Allocate(inputBufSize);
            }
            else
            {
                byte* inputStackBytes = stackalloc byte[inputBufSize];
                utf8InputBytes = inputStackBytes;
                byte* orInalInputStackBytes = stackalloc byte[inputBufSize];
                orInalUtf8InputBytes = orInalInputStackBytes;
            }
            ...
            Unsafe.CopyBlock(orInalUtf8InputBytes, utf8InputBytes, (uint)inputBufSize);

            byte result = ImGuiNative.InputText(
                utf8LabelBytes,
                utf8InputBytes,
                (uint)inputBufSize,
                flags,
                callback,
                user_data.ToPointer());
            if (!Util.AreStringsEqual(orInalUtf8InputBytes, inputBufSize, utf8InputBytes))
            {
            ...
            if (inputBufSize > Util.StackAllocationSizeLimit)
            {
                ...
                Util.Free(orInalUtf8InputBytes);
            }
            ...
            IntPtr user_data)
        {
            ...
            byte result = ImGuiNative.InputTextMultiline(
                utf8LabelBytes,
                utf8InputBytes,
                (uint)inputBufSize,
                size,
            ...
            IntPtr user_data)
        {
            ...
            bool ret = ImGuiNative.InputText(utf8LabelBytes, (byte*)buf.ToPointer(), buf_size, flags, callback, user_data.ToPointer()) != 0;
        ...
        public static bool Begin(string name, ImGuiWindowFlags flags)
        {
            ...
            byte* p_open = null;
            byte ret = ImGuiNative.Begin(utf8NameBytes, p_open, flags);
