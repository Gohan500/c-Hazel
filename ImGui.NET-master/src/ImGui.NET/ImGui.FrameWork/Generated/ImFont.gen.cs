...
namespace ImGui
{
    public unsafe partial struct ImFont
    {
        ...
        public ImFontConfig* ConfData;
        public short ConfDataCount;
    ...
    public unsafe partial struct ImFontPtr
    {
        ...
        public ImFontConfPtr ConfData => new ImFontConfPtr(NativePtr->ConfData);
        public ref short ConfDataCount => ref Unsafe.AsRef<short>(&NativePtr->ConfDataCount);
