...
namespace ImGui
{
    ...
    public unsafe partial struct ImFontConfPtr
    {
        public ImFontConfig* NativePtr { get; }
        public ImFontConfPtr(ImFontConfig* nativePtr) => NativePtr = nativePtr;
        public ImFontConfPtr(IntPtr nativePtr) => NativePtr = (ImFontConfig*)nativePtr;
        public static implicit operator ImFontConfPtr(ImFontConfig* nativePtr) => new ImFontConfPtr(nativePtr);
        public static implicit operator ImFontConfig* (ImFontConfPtr wrappedPtr) => wrappedPtr.NativePtr;
        public static implicit operator ImFontConfPtr(IntPtr nativePtr) => new ImFontConfPtr(nativePtr);
